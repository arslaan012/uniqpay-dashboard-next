...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden font-sans">
      ...
      <aside className="w-72 bg-[#1e293b] dark:bg-[#020617] text-gray-300 flex-shrink-0 hidden lg:flex flex-col border-r border-border/10">
              ...
              <Link 
                ...
                className={cn(
                  ...
                  isActive 
                    ...
                    : "hover:bg-gray-800 dark:hover:bg-slate-900 hover:text-white"
                )}
              >
        ...
        <div className="p-4 border-t border-border/10">
          <div className="bg-gray-800/50 dark:bg-slate-900/50 rounded-xl p-4 border border-border/10">
            ...
            <button className="w-full py-2 bg-gray-700 dark:bg-slate-800 hover:bg-gray-600 dark:hover:bg-slate-700 rounded-lg text-xs font-medium text-white transition-colors">
              Contact Support
            </button>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-4 lg:px-8 shadow-sm z-10">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <button className="hidden md:flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-700 dark:text-indigo-400 rounded-full text-sm font-semibold hover:bg-indigo-100 dark:hover:bg-indigo-950/50 transition-colors border border-indigo-100 dark:border-indigo-900/50">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 pl-2 pr-1 py-1 rounded-full hover:bg-muted border border-transparent hover:border-border transition-all">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-gray-700 to-gray-900 flex items-center justify-center text-white text-xs font-bold ring-2 ring-background">
                    JD
                  </div>
